...
export default function Home() {
  const { markets, loading, error, refetch } = useMarkets('main');
  ...
  return (
    <div className="flex flex-col min-h-screen pull-to-refresh-container">
      <Header title="Live Results" onRefresh={handleRefresh} isRefreshing={isRefreshing} />
      ...
      <main className="flex-1 p-4 space-y-4">
        ...
        {loading && !isRefreshing ? (
          ...
          <EmptyState message="No main markets available right now." />
        ) : (
